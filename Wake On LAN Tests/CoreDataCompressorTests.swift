...
class HostCoreDataFormatterTests: XCTestCase {
    ...
    func testMACAddressCompress() throws {
        ...
        let macAddressData = HostCoreDataFormatter.compress(string: macAddressString, ofType: .macAddress)
    ...
    func testMACAddressDecompress() throws {
        ...
        let macAddressString = HostCoreDataFormatter.decompress(data: macAddressData, ofType: .macAddress)
    ...
    func testIPAddressCompress() throws {
        ...
        let macAddressData = HostCoreDataFormatter.compress(string: macAddressString, ofType: .ipAddress)
    ...
    func testIPAddressDecompress() throws {
        ...
        let macAddressString = HostCoreDataFormatter.decompress(data: macAddressData, ofType: .ipAddress)
