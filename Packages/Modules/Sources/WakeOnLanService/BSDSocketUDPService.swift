...
public final class BSDSocketUDPService {
    public init() { }
}

// MARK: - UDPService
extension BSDSocketUDPService: UDPService {
    public func send(_ packet: [UInt8], to ipAddress: String, port: UInt16) async throws {
        var udpSocket: Int32
