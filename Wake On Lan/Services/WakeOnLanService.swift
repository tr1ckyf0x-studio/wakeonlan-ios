...
final class WakeOnLanService {
    ...
    enum Error: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .socketSetup, .send:
                return R.string.wakeOnLan.wakeOnLanUnexpectedError()
            }
        }
    ...
    private func createMagicPacket(for macAddress: String) throws -> [UInt8] {
        let header = Array<UInt8>(repeating: Constants.magicPocketHeaderByte, count: Constants.magicPocketHeaderLength)
